  ...
  devtools(
    (set, get) => ({
      ...
      setEmployees: (employees) => 
        set({ employees }, false, 'setEmployees'),
      ...
      updateEmployee: (updatedEmployee) =>
        set((state) => {
          ...
          const updatedSelectedEmployee = state.selectedEmployee?.employee_id === updatedEmployee.employee_id
            ? updatedEmployee
      ...
      removeEmployee: (employeeId) =>
        set((state) => ({
          employees: state.employees.filter((emp) => emp.employee_id !== employeeId),
          selectedEmployee: state.selectedEmployee?.employee_id === employeeId 
            ? null 
            : state.selectedEmployee,
        }), false, 'removeEmployee'),
...
export const useSetSelectedEmployee = () => useEmployeeStore((state) => state.setSelectedEmployee);