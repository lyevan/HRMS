...
import FileOvertimeContent from "@/components/modal-contents/file-overtime-content";
import OvertimeDetailsContent from "@/components/modal-contents/overtime-details-content";
...
const Overtime = () => {
  ...
  const fetchOvertimeRequests = async () => {
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Failed to fetch overtime requests"
      );
    } finally {
      setLoading(false);
    }
  ...
  const handleFileOvertimeSuccess = () => {
    fetchOvertimeRequests();
  };
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <Button onClick={() => fetchOvertimeRequests()}>Try Again</Button>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <Button
          onClick={() => setIsFileOvertimeOpen(true)}
                        ...
                        <div className="flex items-center space-x-1">
                          ...
                          <span className="text-sm">
                            {request.start_date && request.end_date
                              ? `${formatRequestTime(
                                  request.start_date
                                )} - ${formatRequestTime(request.end_date)}`
                              : "Duration varies"}
                          </span>
                        </div>
                      </TableCell>
      ...
      <Modal
        ...
        description="View and manage overtime request"
        className="overflow-auto max-h-9/10"
      >
        <OvertimeDetailsContent
