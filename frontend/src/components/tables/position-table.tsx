...
interface PositionTableProps<TData, TValue> {
...
export function PositionTable<TData, TValue>({
  columns,
  data,
  setIsAddPositionModalOpen,
}: PositionTableProps<TData, TValue>) {
      ...
      <div className="flex items-center justify-between w-full gap-2 py-4 font-[Nunito]">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56 font-[Nunito]">
              ...
              >
                ...
                <DropdownMenuRadioItem defaultChecked value="title">
                  Position Title
                </DropdownMenuRadioItem>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            size={isMobile ? "icon" : "default"}
            onClick={() =>
              toast.warning("Export position table implementation coming soon")
            }
          >
            <Download />
            {!isMobile && "Export as"}
